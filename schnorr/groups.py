...
class IntegerGroup:
    ...
    def exponentmult(self, exp1, exp2):
        if not isinstance(exp1, integer_types):
            raise TypeError("exp1 is required to be an integer")
        if not isinstance(exp2, integer_types):
            raise TypeError("exp2 is required to be an integer")
        return (exp1 * exp2) % self.q

    def exponentadd(self, exp1, exp2):
        if not isinstance(exp1, integer_types):
            raise TypeError("exp1 is required to be an integer")
        if not isinstance(exp2, integer_types):
            raise TypeError("exp2 is required to be an integer")
    ...
    def exponentsub(self, exp1, exp2):
        if not isinstance(exp1, integer_types):
            raise TypeError("exp1 is required to be an integer")
        if not isinstance(exp2, integer_types):
            raise TypeError("exp2 is required to be an integer")
        return (exp1 + self.q - exp2) % self.q
